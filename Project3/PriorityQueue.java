...
/**
 * PriorityQueue Class from Lab09
 * Implicitly tested via functionality of simulation classes
 *
...
public class PriorityQueue<T extends Comparable<T>>
{
    ...
    /**
     * returns boolean value representing whether there are any values currently being held by PriorityQueue
     * @return boolean representing whether Queue size==0
     */
    ...
    public String toString(){
        ...
        if(rtn.length()>1) return rtn.substring(0,rtn.length()-2);
        else return rtn;
    }
    /**
